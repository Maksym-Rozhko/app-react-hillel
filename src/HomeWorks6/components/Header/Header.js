...
export default function Header() {
    ...
    <Menu stackable>
        ...
        <Menu.Item className="basket-item">
            ...
            <span className="minicart-quantity" id="basketCounter">{basketCounter()}</span>
            </NavLink>
        </Menu.Item>
    </Menu>
    )
